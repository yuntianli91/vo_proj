 ...
 * @LastEditTime: 2019-07-14 19:07:37
 */
...
class VisualOdometry
{
    public:
        ...
        Sophus::SE3<double> T_c_r_estimated_;  // the estimated pose of current frame 
        ...
        vector<cv::Point3d> pts_3d_; //reference 3d points
        vector<cv::Point2d> pts_2d_; //2d keypoints
